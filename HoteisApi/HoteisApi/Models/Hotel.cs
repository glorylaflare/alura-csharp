...
public class Hotel
{
    ...
    [MaxLength(100, ErrorMessage = "O {0} do hotel não pode exceder {1} caracteres.")]
    public string Nome { get; set; }
    
    [Required(ErrorMessage = "O {0} do hotel é obrigatório.")]
    [MaxLength(200, ErrorMessage = "O {0} do hotel não pode exceder {1} caracteres.")]
    public string Logradouro { get; set; }
    
    [Required(ErrorMessage = "O {0} do hotel é obrigatório.")]
    [MaxLength(100, ErrorMessage = "A {0} do hotel não pode exceder {1} caracteres.")]
    ...
    [Required(ErrorMessage = "O {0} do hotel é obrigatório.")]
    [MaxLength(500, ErrorMessage = "A {0} do hotel não pode exceder {1} caracteres.")]
